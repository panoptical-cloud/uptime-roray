                                                            ...
                                                            <div className="mt-2">
                                                                ...
                                                                <ul className="relative border-l border-gray-200 ml-4">
                                                                    <li className="mb-4 -ml-4 flex items-start">
                                                                        ...
                                                                        <div>
                                                                            <time className="mb-1 text-sm font-normal text-gray-400">09:00 AM [2H 31M ago]</time>
                                                                            <h3 className="text-base font-semibold text-gray-900">Server Booted</h3>
                                                                    ...
                                                                    <li className="mb-2 -ml-4 flex items-start">
                                                                        ...
                                                                        <div>
                                                                            <time className="mb-1 text-sm font-normal text-gray-400">12:30 PM</time>
                                                                            <h3 className="text-base font-semibold text-gray-900">Deployment Completed</h3>
                                                                            <p className="mb-4 text-base font-normal text-gray-500">
